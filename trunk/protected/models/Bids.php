 ...
 * @property integer $userbidId
 * @property integer $cost
 * @property string $comfirm
 * @property string $dateComfirm
 * @property string $create_time
 * @property integer $create_user_id
 * @property string $update_time
 * @property integer $update_user_id
 */
class Bids extends CodethueActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('userbidId',$this->userbidId);
		$criteria->compare('cost',$this->cost);
		$criteria->compare('comfirm',$this->comfirm,true);
		$criteria->compare('dateComfirm',$this->dateComfirm,true);
